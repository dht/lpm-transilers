...
export const stateAfter1 = {
    ...
    style: {container: {alignItems: 'center',justifyContent: 'center',flex: 1,backgroundColor: '#F5FCFF',},text2: {fontSize: 20,textAlign: 'center',margin: 10,},text3: {textAlign: 'center',color: '#333333',marginBottom: '5px',},text4: {textAlign: 'center',color: '#333333',marginBottom: '5px',}},
    dependencies:['StyleSheet', 'View', 'Text']
}

export const formatAfter1 = 'import React, { Component } from \'react\';\nimport {\n    StyleSheet,\n\tView,\n\tText\n} from \'react-native\';\n\nexport default class Layout extends Component {\n    render() {\n        return (\n           <View style={styles.container}>\n\t<Text style={styles.text2}>\n\t\tWelcome to React Native!</Text>\n\t<Text style={styles.text3}>\n\t\tTo get started, edit index.android.js</Text>\n\t<Text style={styles.text4}>\n\t\t Double tap R on your keyboard to reload, Shake or press menu button for dev menu</Text>\n\t</View>\n\n        );\n    }\n}\n\nconst styles = StyleSheet.create({\n    "container": {\n        "alignItems": "center",\n        "justifyContent": "center",\n        "flex": 1,\n        "backgroundColor": "#F5FCFF"\n    },\n    "text2": {\n        "fontSize": 20,\n        "textAlign": "center",\n        "margin": 10\n    },\n    "text3": {\n        "textAlign": "center",\n        "color": "#333333",\n        "marginBottom": "5px"\n    },\n    "text4": {\n        "textAlign": "center",\n        "color": "#333333",\n        "marginBottom": "5px"\n    }\n});';